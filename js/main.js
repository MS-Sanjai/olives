...
document.addEventListener("DOMContentLoaded", function () {
    const links = document.querySelectorAll("a.smoothscroll");
...
document.addEventListener("DOMContentLoaded", function () {
    // Select all links with the .smoothscroll class
    const links = document.querySelectorAll("a.native-scroll");
...
/* Every time scroll happen animation
    * ------------------------------------------------------ */
// document.addEventListener("DOMContentLoaded", () => {
//     const elements = document.querySelectorAll(".animate-left, .animate-right, .animate-bottom");
...
//                 entry.target.classList.add("animate-show");
//             } else {
//                 entry.target.classList.remove("animate-show"); // remove to allow animation every scroll
//             }
//         });
//     }, { threshold: 0.2 });
